...
const Home = () => {
  ...
  return (
    <>
      ...
      <main>
        <section className="flex flex-col lg:flex-row items-center justify-center min-h-screen sm:py-[2rem] lg:py-[3rem] sm:px-[1rem] lg:px-[3rem]">
          {/* Image Section */}
          ...
          <div className="flex flex-col items-start lg:w-1/2">
            ...
            <p className="text-3xl lg:text-[2.5rem] leading-normal lg:leading-[3.5rem] line-clamp-3 mb-4 lg:mb-6 font-bold">
              At Our Business Company We Believe In The Power Of Mental
              Wellness.
            </p>
        ...
        <section className="min-h-screen flex flex-col sm:px-[1rem] lg:px-[3rem] sm:py-[2rem]">
        ...
        {/* Pricing */}
        <section className="flex flex-col items-center justify-center min-h-screen sm:px-[1rem] lg:px-[3rem] sm:py-[2rem] bg-[#eae9e9]">
        ...
        {/* client review */}
        <section className="min-h-screen flex flex-col justify-center px-7">
          <div className="flex flex-col md:flex-row w-full gap-10">
            <div className="flex flex-col w-full md:w-[30%] md:text-left mb-10 md:mb-0">
              <h3 className="text-base font-semibold text-[#f95008] text-opacity-90 mb-[1rem]">
                Client Review
              </h3>
